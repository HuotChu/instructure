 ...
 * MIT License (MIT) - This header must remain intact.
 **/
define('box',['temple'], function(temple) {
    'use strict';
    ...
    return function(uri, post) {
        ...
        return new Promise(function(resolve, reject) {
            var xhr = new XMLHttpRequest(),
                separatorIndex = uri.indexOf('?'),
                sliceIndex = separatorIndex < 0 ? uri.length : separatorIndex,
                resource = uri.indexOf('http') !== -1 ? uri : uri.slice(0, sliceIndex),
 ...
 * MIT License (MIT) - This header must remain intact.
 **/
define('aggregates',['./comparator'], function (comparator) {
    'use strict';
 ...
 * MIT License (MIT) - This header must remain intact.
 **/
define('go',['./aggregates', './comparator'], function (aggregates, comparator) {
    'use strict';
 ...
 * MIT License (MIT) - This header must remain intact.
 **/
define('db',['util', 'comparator', 'Select'], function (util, comparator, Select) {
    'use strict';
        ...
        this.__proto__ = {
            ...
            'insertJsonInto': function (tableName) {
                ...
                return function (insertObjects /*[objects]*/) {
                    var prop, insert, columnNames, add, vals, val,
